# Timers and Interrupts Example

This example demonstrates how to use timers and interrupts on the Raspberry Pi Pico RP2040. An LED is toggled in a timer interrupt.
...
5. **Run the Program**:
    - The onboard LED should toggle every 500 milliseconds.

### Code Explanation

#### main.py
This code initializes GPIO pin 25 as an output pin for the LED and sets up a timer to call the `toggle_led` function every 500 milliseconds. The `toggle_led` function toggles the state of the LED, creating a blinking effect.
