...
This example demonstrates how to read input from a button and control an LED using GPIO pins on the Raspberry Pi Pico RP2040.
...
#### main.py
This code initializes GPIO pin 25 as an output pin for the LED and GPIO pin 14 as an input pin for the button with an internal pull-down resistor. It continuously checks the button state and toggles the LED accordingly.
